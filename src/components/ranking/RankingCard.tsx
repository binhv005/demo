...
export const RankingCard: React.FC<RankingCardProps> = ({ ranking, className = '', onClick }) => {
    ...
    >
      ...
      <div className="relative block aspect-[16/9] w-full overflow-hidden bg-slate-100">
        ...
        <div className="absolute bottom-3 left-3">
          <span className="inline-flex items-center gap-1 text-[11px] font-bold text-white bg-orange-600/90 backdrop-blur-xs px-2.5 py-0.5 rounded-md shadow-xs">
