      ...
      {dialogState.isOpen &&
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 select-none animate-fade-in">
            ...
            {/* Modal Box */}
            <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-white rounded-3xl shadow-2xl border border-slate-100 transform transition-all z-10 p-6 sm:p-7 space-y-5 animate-modal-in">
              {/* Close Button */}
              <button
                onClick={() => handleClose(false)}
